...
function SummittServices1_process_html(&$variables) {
...
function SummittServices1_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function SummittServices1_button($variables) {
 ...
 */
function SummittServices1_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function SummittServices1_menu_local_task($variables) {
 ...
 */
function SummittServices1_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function SummittServices1_node_preview($variables) {
  $node = $variables['node'];
