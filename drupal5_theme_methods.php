...
function SummittServices1_regions() {
  return array(
 ...
 * @ingroup themeable
 */
function SummittServices1_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function SummittServices1_feed_icon($url) {
 ...
 */
function SummittServices1_comment_wrapper($content, $type = null) {
  static $node_type;
